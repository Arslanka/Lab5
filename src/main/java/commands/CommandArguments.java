...
public class CommandArguments {
    ...
    public CommandArguments(Map<String, Command> commandsByName, Map<String, Supplier<Object[]>> stringSupplierMap, Command command, Map<Class<?>, BiFunction<Scanner, Printer, Object>> requestMap) {
